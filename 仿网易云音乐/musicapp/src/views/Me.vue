    ...
    <section class="aui-scrollView">
      ...
      <div class="aui-chang-list">
        ...
        <div class="aui-user-text">
          ...
          <div v-if="$store.state.user.userDetail.profile==0"><span><i class="icon icon-vip"></i>您还未开通VIP</span>
          <button @click="$router.push('/login')">退出登录</button></div>
          <div v-else><span><i class="icon icon-vip"></i>您已经是尊贵的黑胶VIP</span>
